...
local function createPersistentAttributes(player, persistent)
	...
	player:SetAttribute(Attrs.OwnedGooSkinsJson, encodeJson(persistent.OwnedGooSkins))
	player:SetAttribute(Attrs.SelectedGooSkinId, persistent.SelectedGooSkin or "Goo::Default")
	player:SetAttribute(Attrs.GooSkinMultiplier, 1)
